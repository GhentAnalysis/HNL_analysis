...
inbkgdata_e = open(inbkgdir+'majorana/M-4_V-0.00290516780927_e_ele_datacard_16.txt' , 'r')
inbkgdata_m = open(inbkgdir+'majorana/M-4_V-0.00290516780927_mu_muo_datacard_16.txt', 'r')
...
for f in inrootfiles:
    ...
    inbkgroot = r.TFile()
    if '_e_Dirac_ele' in f:
        inbkgroot = r.TFile(inbkgdir+'majorana/shape_file_M-4_V-0.00290516780927_e_ele_16.root' , 'read')
    else:
        inbkgroot = r.TFile(inbkgdir+'majorana/shape_file_M-4_V-0.00290516780927_mu_muo_16.root', 'read')
