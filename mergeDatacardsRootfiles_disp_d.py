...
indir    = 'dataCards_shapeRoot/disp/'
outdir   = 'merged_datacards_rootfiles_2016/'
inbkgdir = 'dataCards_shapeRoot/disp/'

if not os.path.exists(outdir): os.mkdir(outdir)

inbkgdata_e = open(inbkgdir+'majorana/M-4_V-0.00290516780927_e_ele_disp_datacard_16.txt' , 'r')
inbkgdata_m = open(inbkgdir+'majorana/M-4_V-0.00290516780927_mu_muo_disp_datacard_16.txt', 'r')
...
for f in inrootfiles:
    ...
    inbkgroot = r.TFile()
    if '_e_ele' in f:
        inbkgroot = r.TFile(inbkgdir+'majorana/shape_file_M-4_V-0.00290516780927_e_ele_disp_16.root' , 'read')
    else:
        inbkgroot = r.TFile(inbkgdir+'majorana/shape_file_M-4_V-0.00290516780927_mu_muo_disp_16.root', 'read')
