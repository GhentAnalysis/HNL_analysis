...
namespace kinematics{
    ...
    double minMass_OS(const std::vector<TLorentzVector>&, const std::vector<int>&,  std::vector<unsigned>&, int vector_pair[2]);
    double minVar_OS(const std::vector<TLorentzVector>&, const std::vector<int>&,  std::vector<unsigned>&, int vector_pair[2],double (&computeVar)(const TLorentzVector&, const TLorentzVector&));
    double extremum_OS(const std::vector<TLorentzVector>& , const std::vector<int>& ,  std::vector<unsigned>& , int vector_pair[2], double (&computeVar)(const TLorentzVector&, const TLorentzVector&), const double& (& getExtremum) (const double&, const double&), double initVar);
