...
const Color_t colors[9] ={ kBlue-9,  91,98, kRed-10,51, kGreen+3, 8, kGreen, kMagenta +3  };
const Color_t sigCols[43] = {kYellow, kTeal, kGreen, kRed, kCyan, kMagenta, kCyan, kRed-3, kBlue-3, kMagenta -9 ,kYellow+1,kBlue-9,  91,98, kRed-10,51, kGreen+3, 8, kGreen, kMagenta +3,kBlue-9,  91,98, kRed-10,51, kGreen+3, 8, kGreen, kMagenta +3,kBlue-9,  91,98, kRed-10,51, kGreen+3, 8, kGreen, kMagenta +3,kBlue-9,  91,98, kRed-10,51};
